    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <Card className="max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            Edite a URL e a chave anônima (anon key) do projeto Supabase usado por este bot. Teste a
            conexão antes de salvar para confirmar que as credenciais e as permissões estão
            corretas.
          </CardDescription>
        </CardHeader>
        <CardContent>
